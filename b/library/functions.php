...
function doLogin()
{
	...
	if (dbNumRows($result) == 1) {
		...
		$errorMessage = 'Invalid account number or password or Account is not Active. Please try again or contact customer care.';
	}
	return $errorMessage;
}
...
//	$accno 	= (int)$_POST['accno'];
	...
	$result = dbQuery($sql);
	if (dbNumRows($result) == 1) {
		$errorMessage = 'Username already exists, please try another name.';
		return $errorMessage;
	}
	
	//first check if account number is already registered or not...
	...
	*/
	...
	This is to inform you that your Account # $accno is register successfully with HSBC Bank and currently in Inactive state. We will soon contact you once it gets activated.<br/><br/>In case you need any further clarification for the same, please do get in touch with your Customer Care.<br/><br/>
	Regards,<br/>HSBC Bank";
