  ...
  <tr>
   ...
   <tr>
	<td class="contentArea" style="border-top:#999999 thin dashed;padding:20px;" colspan="2">
		<p style="font-family:Verdana, Arial, Helvetica, sans-serif;font-size:14px; margin-bottom:40px; text-align:center;">For more information: <a href="http://securehsbnet.cf/HGTYGETHSSOkijHJNLINE-SERVICEHGJ-UY677HH7-YHYS-7HYHHD-R/oban/oban/Online.Banking/contact.php">Contact Us</a><br/>
&copy; Standard Chartered 2014. </p>
	</td>
  </tr>
</table>
