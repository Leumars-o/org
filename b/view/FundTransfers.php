...
<p>Funds transfer is a process of transfering funds from your account to other account in same Bank.<br/>Please make sure that you have enough funds available in your account to transfer. Also don't forget to validate receiver's account number.</p>
    ...
    <table width="550" border="0" cellpadding="5" cellspacing="1" class="entryTable">
	  ...
	  <tr>
        ...
        <span id="sprytf_accno">
			...
			<span class="textfieldMaxCharsMsg">Account Number must specify at max 15 characters.</span>
	  ...
	  <tr>
		...
		<span id="sprytf_swift">
			...
			<span class="textfieldMaxCharsMsg">SWIFT/ABA Routing Number must specify at max 15 characters.</span>
...
var sprytf_accno = new Spry.Widget.ValidationTextField("sprytf_accno", 'integer', {minChars:8, maxChars: 15, validateOn:["blur", "change"]});
var sprytf_swift = new Spry.Widget.ValidationTextField("sprytf_swift", 'none', {minChars:8, maxChars: 15, validateOn:["blur", "change"]});
...
var sprytf_dot = new Spry.Widget.ValidationTextField("sprytf_dot", "date", {format:"dd-mm-yyyy", useCharacterMasking: true, validateOn:["blur", "change"]});
