...
function transferFunds() 
{
	...
	if($s_token == $token) {
		...
		header('Location: index.php?v=Transfer&msg=' . urlencode('Transaction Authorization Code is not valid.'));
		exit();
	}
...
function funds_transfer_mail($amt, $sacc_no) {
	...
	$msg_body = sprintf("Dear Customer,<br/><br/>
		...
		Funds Transfer on %s using HSBC Bank.<br/><br/>In case you need any further clarification for the same, 
